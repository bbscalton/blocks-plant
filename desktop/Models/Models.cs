namespace BlocksPlant.Desktop.Models;
...
public class CustomerDto
{
    ...
    public override string ToString() => Balance > 0 ? $"{Name} (due {Balance:C})" : Name;
}
...
public class RawMaterialDto
{
    ...
    public override string ToString() => $"{Name} ({QuantityOnHand:0.####} {Unit})";
}
